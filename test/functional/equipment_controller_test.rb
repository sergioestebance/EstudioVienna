...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { quantity: @equipment.quantity, tool: @equipment.tool, trademark: @equipment.trademark }
    end
  ...
  test "should update equipment" do
    put :update, id: @equipment, equipment: { quantity: @equipment.quantity, tool: @equipment.tool, trademark: @equipment.trademark }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
